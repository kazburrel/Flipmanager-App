        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Hello Tyler</h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
                <!--begin::Actions-->
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="../../demo1/dist/.html" class="btn btn-sm btn-light" data-bs-toggle="modal"
                    ...
                    <a href="../../demo1/dist/.html" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                        data-bs-target="#kt_modal_new_target">Add Goal</a>
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
                                    ...
                                    <div class="tab-pane fade show active" id="kt_chart_widgets_22_tab_content_1">
                                        ...
                                        <div class="d-flex flex-wrap flex-md-nowrap">
                                                ...
                                                <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6">
                                                    ...
                                                    <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                                        ...
                                                        <div class="me-2">
                                                            ...
                                                            <span class="text-gray-400 fw-bolder d-block fs-7">Don’t forget
                                                                to turn in your task</span>
                                                        </div>
                                                        <!--end::Section-->
                                                    </div>
                                                    <!--end::Block-->
                                            ...
                                            <div
                                                ...
                                                <!--begin::Title-->
                                                <div class="fs-4 fw-bolder text-gray-900 text-center mb-5">Session
                                                    Attendance
                                            ...
                                            <table class="table align-middle gs-0 gy-4">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#"
                                                                class="text-gray-800 text-hover-primary fw-bolder fs-6">Book
                                                                p. 77-85, read &amp; complete tasks 1-6 on p. 85</a>
                                                            <span
                                                                class="text-gray-400 fw-bolder fs-7 d-block">Physics</span>
                                                        </td>
                                                        <td class="text-end">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span
                                                                class="text-gray-400 fw-bolder fs-7 d-block">History</span>
                                                        </td>
                                                        <td class="text-end">
                                                            <span data-kt-element="status"
                                                                class="badge badge-light-primary">In Process</span>
